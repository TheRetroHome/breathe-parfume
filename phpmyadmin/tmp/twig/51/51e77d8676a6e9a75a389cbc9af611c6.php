...
class __TwigTemplate_ad18b12dbd652f10368a71d8134dc38f extends Template
{
    private $source;
    private $macros = [];
...
($context["servers"] ?? null), "select", [], "any", false, false, false, 35)]));
    ...
    {
        return new Source("", "server/select/index.twig", "C:\\OSPanel\\home\\phpmyadmin\\templates\\server\\select\\index.twig");
    }
}
